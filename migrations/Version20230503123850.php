 ...
 */
final class Version20230503123850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription ADD status_id INT DEFAULT NULL, ADD datedernieremodification DATETIME NOT NULL');
        $this->addSql('ALTER TABLE inscription ADD CONSTRAINT FK_5E90F6D66BF700BD FOREIGN KEY (status_id) REFERENCES status (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription DROP status_id, DROP datedernieremodification');
    }
}
